...
extern "C" {
    ...
    enum llama_rope_scaling_type {
        ...
        LLAMA_ROPE_SCALING_TYPE_NTK         = 4,
        LLAMA_ROPE_SCALING_TYPE_MAX_VALUE   = LLAMA_ROPE_SCALING_TYPE_NTK,
    };
    ...
    // Forward declaration for MoE cache parameters
    ...
    DEPRECATED(LLAMA_API int32_t llama_n_head_kv  (const struct llama_model * model), "use llama_model_n_head_kv instead");
